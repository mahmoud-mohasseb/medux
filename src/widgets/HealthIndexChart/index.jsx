...
// styled components
import { HealthIndexChartWrapper } from "./style";
      ...
      >
        {isDominant && (
          <path
            opacity="0.5"
            d="M5 28.3799V220.38"
            stroke={`url(#scatter_${props.dataKey})`}
            strokeWidth="2"
            strokeLinecap="round"
          />
        )}
        ...
        <HealthIndexChartWrapper>
          <div className="total">
            <div className="total_block total_block--cured">
              ...
              <CountUp
                className="counter h1"
                end={averages[index].cured}
                duration={2}
                decimals={2}
              />
              <span>
                <span className="hidden">patients</span> health rate
              </span>
            </div>
            {variant === "both" && (
              <div className="total_block total_block--sick">
                ...
                <CountUp
                  className="counter h1"
                  end={averages[index].sick}
                  duration={2}
                  decimals={2}
                />
                <span>
                  <span className="hidden">patients</span> sick rate
                </span>
              </div>
            )}
          </div>
          ...
          <Legend overlay={true}>
            ...
            {variant === "both" && (
              <LegendItem color="peach" legend="Sick rate" />
            )}
          </Legend>
        </HealthIndexChartWrapper>
      </WidgetBody>
