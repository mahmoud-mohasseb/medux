...
// styled components
import { StyledAppointmentsScheduler, Container } from "./style";
...
const AppointmentsScheduler = () => {
  ...
  const config = {
    ...
    components: {
      ...
      timeSlotWrapper: ({ children }) => (
        <SelectableSlot>{children}</SelectableSlot>
      ),
    },
    selectable: true,
  ...
  return (
    <Widget name="AppointmentsScheduler">
      <WidgetHeader
        title={`${t("Daily appointments scheduler")}`}
        elRef={headerRef}
      />
      <Container headerHeight={headerHeight}>
        <StyledAppointmentsScheduler {...config} />
        <div
          className={formVisible ? "backdrop visible" : "backdrop"}
