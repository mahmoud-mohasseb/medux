...
export const StyledEvent = styled.div`
  ...
  ${(props) =>
    ...
    background-image: repeating-linear-gradient(45deg, ${disabled(
      props.mode
    )} 0,
  ...
  &:after {
    ...
    display: ${(props) =>
      props.type !== "disabled" && props.type !== "available"
        ? "block"
        : "none"};
  }
  ...
  &.isEnded {
    background-color: ${(props) =>
      props.type !== "disabled" && props.type !== "available" && colors.gray};
    opacity: ${(props) =>
      props.type !== "disabled" && props.type !== "available" && 0.5};
  }
