    ...
    <Tab.Content as={Widget} name="PatientReviews" mobile={600}>
      {selectedTab === "" ? (
        ...
        <>
              ...
              <HeaderWrapper className="main">
                <Wrapper>
                  ...
                  <div className="info">
                    ...
                    <span className="info_rating h2">
                      {currentDoctor.rating["year"].toFixed(2)}
                    </span>
          ...
          {doctors.map((doctor) => {
            const doctorReviews = doctors_reviews.filter(
              (review) => review.id === doctor.id
            )[0].reviews;

            const reviewsByMonth = doctorReviews.filter((review) => {
              return (
                review.date.format("MMMM, YYYY") ===
                months[monthIndex].formatted
              );
            });
            ...
            const reviews =
              variant === "doctor" ? reviewsByDay : reviewsByMonth;
