        ...
        .preview {
          ...
          &:after {
            background: ${theme("theme", {
              light: `linear-gradient(270deg, ${light.widgetBg} 0%, ${rgba(
                light.widgetBg,
                0.0001
              )} 100%)`,
              dark: `linear-gradient(270deg, ${dark.widgetBg} 0%, ${rgba(
                dark.widgetBg,
                0.0001
              )} 100%)`,
            })};
          ...
          &:before {
            background: ${theme("theme", {
              light: `linear-gradient(270deg, ${light.bodyBg} 0%, ${rgba(
                light.bodyBg,
                0.0001
              )} 100%)`,
              dark: `linear-gradient(270deg, ${dark.bodyBg} 0%, ${rgba(
                dark.bodyBg,
                0.0001
              )} 100%)`,
            })};
